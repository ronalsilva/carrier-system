...
export const getCarrierHistorySchema = {
    ...baseTag,
    summary: 'Get carrier score history',
    description: 'Returns the history of scores for a carrier, ordered by most recent first',
    security: [{ bearerAuth: [] }],
    params: {
        type: 'object',
        properties: {
